                ...
                <div :class="classes" :style="mainStyles" v-show="visible">
                    <div :class="contentClasses" ref="content" :style="contentStyles" @click="handleClickModal">
                        ...
                        <!--<div :class="[prefixCls + '-header']"-->
                             ...
                             <!--v-if="showHead"-->
                        <!--&gt;<slot name="header"> <Icon :type="'md'+'-'+icon" size="28" color="#f90"/><div :class="[prefixCls + '-header-inner']">{{ title }}</div></slot></div>-->
                        <div :class="[prefixCls + '-body']">
                            ...
                            <k-split transparent/>
                            <div  align="right">
                                <i-button  @click.native="cancel" :disabled="cancelDisabled">{{localeCancelText}}</i-button>
                                <i-button  @click.native="ok" :disabled="okDisabled">{{localeOkText}}</i-button>
                            </div>
                        </div>
                    </div>
                </div>
