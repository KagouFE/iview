...
<template>
    <Form ref="formValidate" :model="formValidate" :rules="ruleInfo" :label-width="80" nonReplacement>
        ...
        <FormItem label="Date" v-if="type2===1">
            <Row>
                <Col span="11">
                    <FormItem prop="date">
        ...
        <FormItem label="Hobby" prop="interest" v-if='type3===0'>
    ...
    export default {
        ...
        computed: {
            ruleInfo () {
                return {
                    name: [
                        {required: this.changeddd, message: 'The name cannot be empty', trigger: 'blur'}
                    ],
                    mail: [
                        {required: this.changeddd, message: 'Mailbox cannot be empty', trigger: 'blur'},
                        {type: 'email', message: 'Incorrect email format', trigger: 'blur'}
                    ],
                    city: [
                        {required: this.changeddd, message: 'Please select the city', trigger: 'change'}
                    ],
                    gender: [
                    ...
                    date: [
                        {required: this.changeddd, type: 'date', message: 'Please select the date', trigger: 'change'}
                    ],
                    time: [
